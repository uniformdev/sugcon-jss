...
export default ${JSON.stringify(config, null, 2)};`;
  ...
  const configPath = path.resolve('src/temp/config.ts');
  ...
  fs.writeFileSync(
    ...
    configText.replace('export default', 'module.exports = '),
    { encoding: 'utf8' }
  );
};
...
function transformPackageConfig() {
  ...
  return {
    ...
    defaultLanguage: packageConfig.config.defaultLanguage || 'en',
    defaultLanguageName: packageConfig.config.defaultLanguageName || 'English',
    defaultFontSize: packageConfig.config.defaultFontSize || 'z100',
    defaultContrast: packageConfig.config.defaultContrast || 'theme1',
  };
}
